...
that `crawl::crwMLE()` requires. Essentially, the `a` parameter is the 
starting coordinates along with a starting velocity (typically `0`). `P` is
...
tbl_locs_fit$params %>% walk(pander::pander,caption = "crwMLE fit parameters")
```
...
tbl_locs_activity_fit$params %>% walk(pander::pander,caption = "crwMLE fit parameters")
